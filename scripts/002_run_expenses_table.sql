-- Execute the expenses table creation script
-- This is a new version to ensure the table gets created properly
...
-- Insert demo data that matches the app's structure
